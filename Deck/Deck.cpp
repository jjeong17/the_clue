...
Deck::Deck() {
	Card* culprit_cards = this->generate_culprit_card_deck();
	Card* non_culprit_cards = this->generate_non_culprit_card_deck(culprit_cards);
	Card* shuffled_non_culprit_cards = this->shuffle_deck(non_culprit_cards);
...
Card* Deck::generate_non_culprit_card_deck(Card* culprit_deck) {
...
Card* Deck::shuffle_deck(Card* non_culprit_cards) {
